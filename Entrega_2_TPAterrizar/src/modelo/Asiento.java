...
public class Asiento {
	...
	private final String claseAsiento; // T, E, P - No va cambiar una ves que se defina.
	...
	public Asiento(Vuelo vuelo, String claseAsiento, 
			String ubicacionAsiento, String estadoAsiento) {
		this.vuelo = vuelo;
