...
public class OceanicBusquedaCompraYReserva{
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////////
	//Busqueda en oceanic
	public static List<AsientoDTO> asientosDisponiblesParaOrigen(OceanicCriterioDeBusqueda criterioBusqueda) {
	...
	public static List<AsientoDTO> asientosDisponiblesParaOrigenYDestino(OceanicCriterioDeBusqueda criterioBusqueda) {
	...
	public static List<AsientoDTO> asientosDisponibles(List<Vuelo> vuelosModificados){
		return vuelosModificados.stream()
				...
				.filter(asiento -> asiento.getEstadoAsiento() == null) //si su estado es null, son asientosDTO.
				.map(AsientoDTO::new)
				.collect(Collectors.toList());
	}	
}